...
function decodeType2Message(str) {
	...
	if (Object.prototype.toString.call(str) !== '[object String]') {
		...
		else if(str.hasOwnProperty('caseless') && str.caseless.hasOwnProperty('dict') && str.caseless.dict.hasOwnProperty('www-authenticate')   ){
            str = str.caseless.dict['www-authenticate'];
        }
		else {
			throw new Error('Invalid argument');
		}
